...
- Bump Java SDK (Android) from v8.1.0-2-g3b43bd2b to v8.1.0 ([#3](https://github.com/tustanivsky/sentry-unreal/pull/3))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#810)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.1.0-2-g3b43bd2b...8.1.0)
